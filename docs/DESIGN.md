...
- **Ambient Shadows:** For floating elements (Modals, Hovered Cards), use ultra-diffused shadows.
  - _Shadow Blueprint:_ `0px 20px 40px rgba(0, 55, 176, 0.06)`. Note the blue tint in the shadow—this mimics natural ambient light rather than a "dirty" black shadow.
...
**Director's Final Note:** This system is about the _invisible_ details. Ensure that the 24px corner radius is consistent across all major containers. The "luxury" comes from the rhythm of the spacing and the lack of visual "noise." Keep it breathing. Keep it luminous.```
````
